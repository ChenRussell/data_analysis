...
public class MinimizingMakeChange {
	 ...
	 *            the target amount of change for which this method is attempting to
	 *            produce the minimum number of coins
	 * @param a_doMonitor
	 *            true: turn on monitoring for later evaluation of evolution
	 *            progress
	 *
	 * @throws Exception
	 *
	...
	public static void makeChangeForAmount(int a_targetChangeAmount, boolean a_doMonitor) throws Exception {
		...
		System.out.println(
				"\t" + MinimizingMakeChangeFitnessFunction.getNumberOfCoinsAtGene(bestSolutionSoFar, 1) + " dimes.");
		System.out.println(
	...
	/**
	 * Main method. A single command-line argument is expected, which is the amount
	 * of change to create (in other words, 75 would be equal to 75 cents).
	 *
	 * @param args
